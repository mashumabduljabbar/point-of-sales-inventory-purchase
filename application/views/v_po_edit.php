      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
				  <div class="row">
					<?php echo form_open_multipart("po/po_aksi_ubah/".$tbl_po->id_po); ?>
					<div class="col-md-4">
					  <div class="form-group">
						<label>RFQ</label>
						<select name="id_rfq" class="form-control" data-placeholder="Pilih RFQ" onchange="location = '<?php echo base_url();?>po/po_ubah/'+this.value;" required >
							<?php if($this->uri->segment(4)!=''){
								echo "<option value='$tbl_rfq_by->id_rfq'>$tbl_rfq_by->nama_supplier</option>";
							}else{
								echo "<option>Pilih RFQ</option>";
							} ?>
							<?php foreach($tbl_rfq as $rfq){?>
								<option value="<?php echo $rfq->id_rfq;?>"><?php echo $rfq->nama_supplier;?></option>
							<?php } ?>
						</select>
					  </div>
					  <div class="form-group">
...
<script type="text/javascript">
	...
	$.getJPON("<?php echo base_url('produk/tbl_produk');?>", function(data) {

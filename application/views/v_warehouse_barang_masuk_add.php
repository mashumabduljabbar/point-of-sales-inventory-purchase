      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("warehouse/barang_masuk_aksi_tambah"); ?>
					<div class="col-md-4">
					  <div class="form-group">
						<label>PO</label>
						<select name="id_po" class="form-control" data-placeholder="Pilih PO" onchange="location = '<?php echo base_url();?>warehouse/barang_masuk_tambah/'+this.value;" required >
							<?php if($this->uri->segment(3)!=''){
								echo "<option value='$tbl_po_by->id_po'>$tbl_po_by->id_po $tbl_po_by->nama_supplier</option>";
							}else{
								echo "<option>Pilih PO</option>";
							} ?>
							<?php foreach($tbl_po as $po){?>
								<option value="<?php echo $po->id_po;?>"><?php echo $po->id_po;?> <?php echo $po->nama_supplier;?></option>
							<?php } ?>
						</select>
					  </div>
					  <div class="form-group">

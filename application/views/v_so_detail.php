					...
					<div class="box-body">
					  <div class="row">
						...
						<div class="col-md-6">
							<div class="box-body"  style="border:1px solid #F4F4F4;">
								<table class="table-condensed">
									<tr><td width="130px">Tanggal</td><td width="20px">:</td><td><?php echo $tbl_po->tanggal_po;?></td></tr>
								</table>
							</div>
						</div>
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="box-body"  style="border:1px solid #F4F4F4;">
								<table class="table-condensed">
									<tr><td width="130px">Penerima</td><td width="20px">:</td><td><b><?php echo $tbl_so_by->nama_customer;?></b></td></tr>
									<tr><td>Alamat</td><td width="20px">:</td><td><?php echo $tbl_so_by->alamat_customer;?></td></tr>
									<tr><td>Alamat Pengiriman</td><td width="20px">:</td><td><?php echo $tbl_po->alamat_pengiriman_po;?></td></tr>
									<tr><td>NPWP</td><td width="20px">:</td><td><?php echo $tbl_so_by->npwp_customer;?></td></tr>
									<tr><td>No.Telp</td><td width="20px">:</td><td><?php echo $tbl_so_by->no_telp_customer;?></td></tr>
									<tr><td>Email</td><td width="20px">:</td><td><?php echo $tbl_so_by->email_customer;?></td></tr>
								</table>
							</div>
						</div>
					  </div>
								...
								<table width="100%" class="table table-condensed">
										...
										<?php $x++; }?>
											...
											<tr>
												...
												<td>
													<b>Tax <?php echo $tbl_po->tax_po;?></b>
												</td>
												<td style="text-align:right;">
													<b><?php echo $tbl_po->tax;?></b>
												</td>
											</tr>
											<tr>
												<td colspan="5">

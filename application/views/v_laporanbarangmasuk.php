      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="col-md-3">
				...
				<label>Periode</label>
					<select name="id_rfq" class="form-control" onchange="location = '<?php echo base_url();?>report/laporanbarangmasuk/'+this.value;" required >
							<?php 
							...
							<?php foreach($laporanbarangmasuk as $data){?>
...
var myTable =  $('#datatable').DataTable({
			...
			"ordering": false,
			'order': [[0, 'asc']],
			"ajax": "<?php echo base_url('report/get_data_master_laporanbarangmasuk/'.$periode);?>" ,
			aLengthMenu: [
				[25, 50, 100, 200, -1],
				[25, 50, 100, 200, "All"]
			],

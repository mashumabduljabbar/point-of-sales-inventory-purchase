		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					...
					<?php if(isset($_POST['nama_supplier'])){?>
						<p style="color:red;"><i>Nama Supplier telah digunakan, coba yang lain.</i></p>
						<?php
							$nama_supplier = $_POST['nama_supplier'];
							$npwp_supplier = $_POST['npwp_supplier'];
				  ...
				  <?php echo form_open_multipart("supplier/supplier_aksi_tambah"); ?>
					<div class="col-md-4">
					  <div class="form-group">
						...
						<input type="text" class="form-control" name="nama_supplier" placeholder="Nama Supplier, Contoh : PT XYZ" value="<?php echo $nama_supplier;?>">
					  </div>
					  <div class="form-group">
						<label>NPWP</label>
					  ...
					  <div class="form-group">
						<label>Email</label>
						<input type="email" class="form-control" name="email_supplier" placeholder="Email" value="<?php echo $email_supplier;?>">
					  </div>
					</div>
					<div class="col-md-4">
					  <div class="form-group">

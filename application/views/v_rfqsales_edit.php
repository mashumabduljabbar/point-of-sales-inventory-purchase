					...
					<div class="col-md-12">
								...
								<table id="tambahproduklainnya" width="100%" class="table">
									...
									<tr>
										...
										<td>
											<select data-placeholder='Jenis Biaya' class='form-control' name='id_produk[]' style='width: 100%;' >
													<option value='<?php echo $detail->id_produk;?>'> <?php echo $detail->nama_produk;?></option>
											</select>
										</td>
										<td>
											<input type="number" class="form-control" name="harga_rfq_detail[]" placeholder="Harga" value="<?php echo $detail->harga_rfq_detail;?>">
										</td>
										<td>
											<input type="number" class="form-control" name="qty_rfq_detail[]" placeholder="Qty" value="<?php echo $detail->qty_rfq_detail;?>">
										</td>
										<td>
											<input type="number" class="form-control" name="disc_rfq_detail[]" placeholder="Discount" value="<?php echo $detail->disc_rfq_detail;?>">
										</td>
										<td><a href="<?php echo base_url("rfqsales/rfq_hapus_detail/$detail->id_rfq_detail/$tbl_rfq->id_rfq");?>" onclick="return confirm('Yakin untuk Hapus <?php echo $detail->nama_produk;?>?');" class="btn btn-md btn-danger"><i class="fa fa-trash"></i> </a></td>
									</tr>
									<?php $x++; }?>
